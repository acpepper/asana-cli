...
def move_tasks_inner(source_project, source_section, target_project, target_section):
    ...
    """
    source_project_id, source_project_name = source_project['gid'], source_project['name']
    source_section_id, source_section_name = source_section['gid'], source_section['name']
    target_project_id, target_project_name = target_project['gid'], target_project['name']
    target_section_id, target_section_name = target_section['gid'], target_section['name']
